...
python train.py fit  -c configs/swinIR3D.yaml --trainer.devices [0] --trainer.name "SwinIR3D-Grad" --model.use_gradients true --model.mixed false --model.grad_weight 4.0 --data.augm "color"
