...
python train.py fit  -c configs/config-SR.yaml --trainer.devices [0] --trainer.name "SwinIR-Mix" --model.use_gradients true  --model.grad_weight 4.0 --model.mode "mix" --model.mix true

python train.py fit  -c configs/config-SR.yaml --trainer.devices [0] --trainer.name "SwinIR-RGB" --model.use_gradients false --model.grad_weight 0.0
